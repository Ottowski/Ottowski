...
- 🌱 Recently finished a 2-year Fullstack Java program with additional education in Python, AWS, AI/MachineLearning and SecureDevOps.
...
| [⚔️ MyWarhammerProject](https://github.com/Ottowski/MyWarhammerProject) | A fan-driven Warhammer project where I explore structured unit data and future integrations with APIs for lore, stats, and more. Currently focused on modeling game data with Java and planning future web integration. | Java, Spring Boot, SQL |
